...
var node_2 = require("@aries-framework/node");
...
var agent = new core_1.Agent(config, node_1.agentDependencies);
...
var initialize = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, agent.initialize().then(function (result) { })["catch"](console.error)];
